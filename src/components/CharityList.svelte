    ...
    <div class="container">
        <div class="xs-heading row xs-mb-60">
            <div class="col-md-9 col-xl-9">
                ...
                <p>Donasi insyaAllah akan disalurkan ke panti asuhan disekitar kota Semarang. Yuk ikutan jadi volunteer, kita akan membagikan sedikit rejeki yang mungkin sangat berarti untuk mereka.</p>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                                ...
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input required type="number" class="form-control" id="exampleInputAmount"
                                            aria-describedby="amountHelp" placeholder="Masukkan nominal yang ingin didonasikan">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName">Nama</label>
                                        <input required type="text" class="form-control" id="exampleInputName"
                                            aria-describedby="nameHelp" placeholder="Masukkan nama lengkap">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary">Pilih Pembayaran</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="xs-popular-item xs-box-shadow">
                    ...
                    <div class="xs-item-content">
                        ...
                        <ul class="xs-list-with-content">
                            <li>{formatCurrency(charity.pledged)}<span>Donasi <br> terkumpul</span></li>
                            <li><span class="number-percentage-count number-percentage" data-value="90"
                                    data-animation-duration="3500">{calculateFunded(charity.pledged,charity.target)}</span>% <span>Target<br> Tercapai</span></li>
                            <li>{calculateDaysRemaining(charity.date_end)}<span>Hari<br> tersisa</span></li>
                        </ul>
